...
(setq load-path (cons (expand-file-name "/Applications/Emacs24.app/Contents/Resources/site-lisp/yatex") load-path))
;; プレビュー(TeXShop の使用)
(setq tex-command "~/Library/TeXShop/bin/platex2pdf-utf8" dvi2-command "open 
-a TexShop") 
